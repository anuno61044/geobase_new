...
class MediaVideoFieldRender implements IFieldRenderClass {
  factory MediaVideoFieldRender() {
    return _instance;
  }

  MediaVideoFieldRender._internal();

  static final MediaVideoFieldRender _instance =
      MediaVideoFieldRender._internal();
  @override
