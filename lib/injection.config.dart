...
import 'package:geobase/src/domain/services/column_service.dart' as _i64;
...
import 'package:latlong2/latlong.dart' as _i78;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i16.IColumnService>(() => _i64.ColumnsService(
          gh<_i8.IColumnRepository>(),
          gh<_i8.IGeodataRepository>(),
        ));
    gh.factory<_i8.IConfigurationRepository>(() =>
        _i65.ConfigurationRepository(gh<_i40.ILocalPreferencesProvider>()));
    gh.factoryParam<_i66.IGeodataCreateFormBloc, _i67.GeodataCreateInitialData?,
        dynamic>((
      createInitialData,
      _,
    ) =>
        _i66.GeodataCreateFormBloc(
          geodataService: gh<_i52.IGeodataService>(),
          createInitialData: createInitialData,
        ));
    gh.factoryParam<_i68.IGeodataEditFormBloc, _i67.GeodataEditInitialData?,
        dynamic>((
      editInitialData,
      _,
    ) =>
        _i68.GeodataEditFormBloc(
          geodataService: gh<_i52.IGeodataService>(),
          editInitialData: editInitialData,
        ));
    gh.lazySingleton<_i52.ILocationReaderService>(
        () => _i69.LocationReaderService(gh<_i8.ILocationRepository>()));
    gh.lazySingleton<_i16.IMapConfigurationReaderService>(() =>
        _i70.MapConfigurationReaderService(gh<_i8.IConfigurationRepository>()));
    ...
    gh.lazySingleton<_i16.IUserPreferencesReaderService>(() =>
        _i72.UserPreferencesReaderService(gh<_i73.IConfigurationRepository>()));
    gh.lazySingleton<_i16.IUserPreferencesWritterService>(() =>
        _i74.UserPreferencesWritterService(
            gh<_i73.IConfigurationRepository>()));
    gh.factory<_i75.LocationCubit>(() =>
        _i75.LocationCubit(locationService: gh<_i52.ILocationReaderService>()));
    gh.factory<_i76.MapConfigurationFormBloc>(
        () => _i76.MapConfigurationFormBloc(
              readerService: gh<_i16.IMapConfigurationReaderService>(),
              writterService: gh<_i16.IMapConfigurationWritterService>(),
            ));
    gh.factoryParam<_i77.MapCubit, _i78.LatLng?, dynamic>((
      initialLocation,
      _,
    ) =>
        _i77.MapCubit(
    ...
    gh.factory<_i79.MarkerCubit>(() => _i79.MarkerCubit(
          markerGetterService: gh<_i16.IMarkerGetterService>(),
          uPrefsReader: gh<_i16.IUserPreferencesReaderService>(),
        ));
    gh.factory<_i80.CategoriesExporterCubit>(
        () => _i80.CategoriesExporterCubit(gh<_i16.ICategoryService>()));
    gh.factory<_i81.CategoriesMapSelectorCubit>(
        () => _i81.CategoriesMapSelectorCubit(
              gh<_i16.ICategoryService>(),
              gh<_i16.IUserPreferencesReaderService>(),
            ));
    gh.factory<_i82.CategoriesShowerCubit>(
        () => _i82.CategoriesShowerCubit(gh<_i16.ICategoryService>()));
    gh.factory<_i83.CategoryCreateFormBloc>(() => _i83.CategoryCreateFormBloc(
          categoryService: gh<_i52.ICategoryService>(),
          fieldTypeService: gh<_i52.IFieldTypeService>(),
        ));
    gh.factoryParam<_i84.CategoryEditFormBloc, int?, dynamic>((
      categoryId,
      _,
    ) =>
        _i84.CategoryEditFormBloc(
          categoryId: categoryId,
          categoryService: gh<_i52.ICategoryService>(),
          fieldTypeService: gh<_i52.IFieldTypeService>(),
        ));
    gh.factory<_i85.CategoryListBloc>(
        () => _i85.CategoryListBloc(gh<_i52.ICategoryService>()));
    gh.factory<_i86.CategoryViewCubit>(
        () => _i86.CategoryViewCubit(gh<_i52.ICategoryService>()));
    gh.factory<_i87.GeodataCreateCubit>(() => _i87.GeodataCreateCubit(
          gh<_i52.ICategoryService>(),
          gh<_i52.ILocationReaderService>(),
        ));
    gh.factory<_i88.GeodataNewCubit>(
        () => _i88.GeodataNewCubit(gh<_i16.ICategoryService>()));
    return this;
  }
}
