...
import 'package:geobase/src/domain/services/categories_service.dart' as _i60;
...
import 'package:latlong2/latlong.dart' as _i76;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i54.FormViewCubit>(
        () => _i54.FormViewCubit(gh<_i52.IFieldTypeFormService>()));
    gh.factory<_i55.GeodataEditCubit>(
        () => _i55.GeodataEditCubit(gh<_i52.IGeodataService>()));
    gh.factory<_i56.GeodataExporterCubit>(
        () => _i56.GeodataExporterCubit(gh<_i16.IGeodataService>()));
    gh.factory<_i57.GeodataListBloc>(
        () => _i57.GeodataListBloc(gh<_i52.IGeodataService>()));
    gh.factory<_i58.GeodataPreviewCubit>(
        () => _i58.GeodataPreviewCubit(gh<_i16.IGeodataService>()));
    gh.factory<_i59.GeodataViewCubit>(
        () => _i59.GeodataViewCubit(gh<_i52.IGeodataService>()));
    gh.lazySingleton<_i16.ICategoryService>(() => _i60.CategoriesService(
          gh<_i8.ICategoriesRepository>(),
          gh<_i8.IGeodataRepository>(),
        ));
    gh.lazySingleton<_i61.IColumnRepository>(
        () => _i62.ColumnRepository(provider: gh<_i10.IColumnsProvider>()));
    gh.factory<_i8.IConfigurationRepository>(() =>
        _i63.ConfigurationRepository(gh<_i40.ILocalPreferencesProvider>()));
    gh.factoryParam<_i64.IGeodataCreateFormBloc, _i65.GeodataCreateInitialData?,
        dynamic>((
      createInitialData,
      _,
    ) =>
        _i64.GeodataCreateFormBloc(
          geodataService: gh<_i52.IGeodataService>(),
          createInitialData: createInitialData,
        ));
    gh.factoryParam<_i66.IGeodataEditFormBloc, _i65.GeodataEditInitialData?,
        dynamic>((
      editInitialData,
      _,
    ) =>
        _i66.GeodataEditFormBloc(
          geodataService: gh<_i52.IGeodataService>(),
          editInitialData: editInitialData,
        ));
    gh.lazySingleton<_i52.ILocationReaderService>(
        () => _i67.LocationReaderService(gh<_i8.ILocationRepository>()));
    gh.lazySingleton<_i16.IMapConfigurationReaderService>(() =>
        _i68.MapConfigurationReaderService(gh<_i8.IConfigurationRepository>()));
    gh.lazySingleton<_i16.IMapConfigurationWritterService>(() =>
        _i69.MapConfigurationWritterService(
            gh<_i8.IConfigurationRepository>()));
    gh.lazySingleton<_i16.IUserPreferencesReaderService>(() =>
        _i70.UserPreferencesReaderService(gh<_i71.IConfigurationRepository>()));
    gh.lazySingleton<_i16.IUserPreferencesWritterService>(() =>
        _i72.UserPreferencesWritterService(
            gh<_i71.IConfigurationRepository>()));
    gh.factory<_i73.LocationCubit>(() =>
        _i73.LocationCubit(locationService: gh<_i52.ILocationReaderService>()));
    gh.factory<_i74.MapConfigurationFormBloc>(
        () => _i74.MapConfigurationFormBloc(
              readerService: gh<_i16.IMapConfigurationReaderService>(),
              writterService: gh<_i16.IMapConfigurationWritterService>(),
            ));
    gh.factoryParam<_i75.MapCubit, _i76.LatLng?, dynamic>((
      initialLocation,
      _,
    ) =>
        _i75.MapCubit(
    ...
    gh.factory<_i77.MarkerCubit>(() => _i77.MarkerCubit(
          markerGetterService: gh<_i16.IMarkerGetterService>(),
          uPrefsReader: gh<_i16.IUserPreferencesReaderService>(),
        ));
    gh.factory<_i78.CategoriesExporterCubit>(
        () => _i78.CategoriesExporterCubit(gh<_i16.ICategoryService>()));
    gh.factory<_i79.CategoriesMapSelectorCubit>(
        () => _i79.CategoriesMapSelectorCubit(
              gh<_i16.ICategoryService>(),
              gh<_i16.IUserPreferencesReaderService>(),
            ));
    gh.factory<_i80.CategoriesShowerCubit>(
        () => _i80.CategoriesShowerCubit(gh<_i16.ICategoryService>()));
    gh.factory<_i81.CategoryCreateFormBloc>(() => _i81.CategoryCreateFormBloc(
          categoryService: gh<_i52.ICategoryService>(),
          fieldTypeService: gh<_i52.IFieldTypeService>(),
        ));
    gh.factoryParam<_i82.CategoryEditFormBloc, int?, dynamic>((
      categoryId,
      _,
    ) =>
        _i82.CategoryEditFormBloc(
          categoryId: categoryId,
          categoryService: gh<_i52.ICategoryService>(),
          fieldTypeService: gh<_i52.IFieldTypeService>(),
        ));
    gh.factory<_i83.CategoryListBloc>(
        () => _i83.CategoryListBloc(gh<_i52.ICategoryService>()));
    gh.factory<_i84.CategoryViewCubit>(
        () => _i84.CategoryViewCubit(gh<_i52.ICategoryService>()));
    gh.factory<_i85.GeodataCreateCubit>(() => _i85.GeodataCreateCubit(
          gh<_i52.ICategoryService>(),
          gh<_i52.ILocationReaderService>(),
        ));
    gh.factory<_i86.GeodataNewCubit>(
        () => _i86.GeodataNewCubit(gh<_i16.ICategoryService>()));
    return this;
  }
}
